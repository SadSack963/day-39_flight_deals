...
class FlightSearch:
    ...
    def flight_search(self, fd: flight_data.FlightData):
        ...
        body = {
            "fly_from": f"city:{fd.fly_from}",
            "fly_to": f"city:{fd.fly_to}",
            "date_from": fd.date_from,
            "date_to": fd.date_to,
            "nights_in_dst_from": fd.nights_in_dst_from,
            "nights_in_dst_to": fd.nights_in_dst_to,
            "flight_type": fd.flight_type,  # will be deprecated in the near future
            "max_stopovers": fd.max_stopovers,
            "one_for_city": fd.one_for_city,
            "curr": fd.curr,
            "price_to": fd.price_to,
            "sort": fd.sort,
        }
